...
feature_extractor = WhisperFeatureExtractor.from_pretrained(pre_trained_model)

# - Load Tokenizer: WhisperTokenizer
tokenizer = WhisperTokenizer.from_pretrained(pre_trained_model, language=language, task="transcribe")

# - - - - - - - - - - - - - - - - - - - - - |
# STEP 3. Combine elements with WhisperProcessor
processor = WhisperProcessor.from_pretrained(pre_trained_model, language=language, task="transcribe")
...
model = WhisperForConditionalGeneration.from_pretrained(pre_trained_model)
